...
--
-- Hôte : 127.0.0.1
-- Généré le : mer. 13 oct. 2021 à 17:12
...
('1977102', '1977-03-01', '1985-03-01', '148A12', '1', 'B01'),
('1985076', '1985-03-01', '2002-09-15', '148A12', '3', 'F01'),
('2000098', '2002-09-15', NULL, '156A12', '4', 'G01'),
('2002181', '2000-09-01', '2010-10-10', '148A12', '2', 'F01'),
('2008045', '2010-10-10', NULL, '196A12', '1', 'E21'),
('2008111', '2008-05-05', '2008-10-17', '196A12', '6', 'F01'),
('2010065', '2008-10-17', NULL, '156A12', '5', 'G01');
...
CREATE TABLE `poste` (
  ...
  `caracteristiques` varchar(60) NOT NULL,
...
INSERT INTO `poste` (`id`, `libelle`, `caracteristiques`, `indice`) VALUES
('1', 'Magasinier(e)', 'Magasinier(e) en reserve', 385),
...
('5', 'Chargé(e) d\'équipe', 'Manage une équipe de 10 hôte(sse)s de caisse', 430),
...
ALTER TABLE `contrat`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idSal` (`idSal`),
  ADD KEY `contrat_ibfk_1` (`idPoste`);
